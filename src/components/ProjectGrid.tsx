...
function LabGatewayCard() {
  return (
    <article className="group flex h-full min-h-full flex-col overflow-hidden rounded-2xl border border-slate/15 bg-ink text-cream shadow-sm transition duration-300 hover:-translate-y-1 hover:border-tomato/40 hover:shadow-soft">
      <div className="relative overflow-hidden bg-[linear-gradient(135deg,rgba(255,247,232,0.12),rgba(47,125,79,0.18))] p-5">
        ...
        <div className="relative mt-10 flex items-end justify-between gap-4">
          <div>
            ...
            <h3 className="mt-2 font-display text-[1.8rem] font-black leading-[1.02] text-cream">
              Coulisses techniques du portfolio
            </h3>
          </div>
      ...
      <div className="flex flex-1 flex-col p-5 md:p-6">
        <p className="grow text-sm leading-6 text-cream/75">
          Infrastructure VPS, domaines, HTTPS, déploiement, bases de données et maintenance : l'envers du décor qui
          permet aux projets de tenir debout.
        </p>
