export const skillBlocks = [
  ...
  {
    title: "Design",
    description: "Direction artistique, identité visuelle, UI, affiches, covers et univers de marque.",
    items: ["Branding", "UI design", "DA", "Typographie", "Covers", "Graphisme"],
  },
  {
    title: "Produit",
    description: "Analyse du besoin, parcours utilisateur, MVP, priorisation et transformation d'idée en outil.",
    items: ["MVP", "Parcours", "Dashboard", "Priorisation", "Architecture", "Tests terrain"],
  },
];
